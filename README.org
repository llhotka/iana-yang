...
#+end_src
** Prerequisites
The essential prerequisites for generating the modules are [[https://curl.se][curl]] and [[http://xmlsoft.org/XSLT/xsltproc2.html][xsltproc]]. In addition, [[https://www.gnu.org/software/make][GNU Make]] and [[https://www.gnu.org/software/grep][GNU Grep]] are needed, as well as a few other command-line utilities that are included in Linux, MacOS and other Unix-like operating systems.
...
| YANG module         | IANA registries           |
|---------------------+---------------------------|
| [[file:registries/quic/iana-quic-versions][iana-quic-versions]]  | [[https://www.iana.org/assignments/quic/quic.xhtml#quic-versions][QUIC Versions]]             |
| [[file:registries/quic/iana-quic-transport][iana-quic-transport]] | [[https://www.iana.org/assignments/quic/quic.xhtml#quic-transport][QUIC Transport Parameters]] |
